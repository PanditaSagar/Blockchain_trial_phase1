...
Blockchain.prototype.createNewTransaction = function(amount,sender,recipient){  //Refactoring new TRansaction method.
...
Blockchain.prototype.chainIsValid = function(blockchain){
    ...
    for(var i =1;i<blockchain.length;i++){
        ...
        if(currentBlock['previousBlockHash'] !== previousBlock['hash'])  validChain =false; // chain not valid        
    };
